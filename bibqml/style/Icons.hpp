...
///
/// Helper function to build the source url of an icon resource, \p name is its file name inside the module resource folder.
...
///
/// QML Icons singleton.
/// This class provides the icon sources of the module.
